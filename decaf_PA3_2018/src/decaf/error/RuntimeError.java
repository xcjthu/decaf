...
public final class RuntimeError {
	...
	public static final String NEGATIVE_ARR_SIZE_DOUBLE_MOD = "Decaf runtime error: The length of the created array should not be less than 0.\n";
	...
	public static final String DIV_BY_0 = "Decaf runtime error: Division by zero error.\n";
