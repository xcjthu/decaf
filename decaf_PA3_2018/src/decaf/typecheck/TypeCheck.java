...
public class TypeCheck extends Tree.Visitor {
    ...
    public void visitScopy(Tree.Scopy scopy) {
        ...
        }else if (scopy.type != BaseType.ERROR && scopy.ident.type != BaseType.ERROR
                && scopy.expr.type != BaseType.ERROR && !scopy.expr.type.equal(scopy.ident.type)) {
    ...
    public void visitArrayConstDoubleMod(Tree.ArrayConstDoubleMod arrayConstDoubleMod){
        ...
        if (arrayConstDoubleMod.expr1.type.equal(BaseType.VARUNDEFINE)
                || arrayConstDoubleMod.expr1.type.equal(BaseType.VOID)){
    ...
    public void visitArrayDefault(Tree.ArrayDefault arrayDefault){
        ...
        if (!arrayDefault.expr1.type.isArrayType()){
            ...
            if (!(arrayDefault.expr3.type.equal(BaseType.VARUNDEFINE)
                    || arrayDefault.expr3.type.equal(BaseType.VOID))){
        ...
        }else if (!arrayDefault.expr3.type.equal(((ArrayType)arrayDefault.expr1.type).getElementType())
                || arrayDefault.expr3.type.equal(BaseType.VARUNDEFINE)
                || arrayDefault.expr3.type.equal(BaseType.VOID)){
