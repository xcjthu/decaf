...
public abstract class Tree {
    ...
    public static final int DOUBLEPLUS = FOREACHSTMT + 1;
    public static final int DOUBLEMOD = DOUBLEPLUS + 1;
    ...
    public static class VarStmt extends Tree{
        public String name;
        public Expr expr;
        public VarStmt(String name, Expr expr, Location loc){
            super(VARSTMT, loc);
            this.name = name;
            this.expr = expr;
        }
