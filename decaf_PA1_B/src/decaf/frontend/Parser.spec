...
'+'  '-'  '*'  '/'  '%'  '='  '>'  '<'  '.'
','  ';'  '!'  '('  ')'  '['  ']'  '{'  '}' ':'
SCOPY SEALED IFOR VAR DOUBLEMOD DOUBLEPLUS
DEFAULT IN FOREACH ARRAYCOMBEGIN ARRAYCOMEND
...
ClassDef        :   CLASS IDENTIFIER ExtendsClause '{' FieldList '}'
                    {
                        /*$$.cdef = new Tree.ClassDef(false, $3.ident, $4.ident, $6.flist, $1.loc);*/
                ...
                |   SEALED CLASS IDENTIFIER ExtendsClause '{' FieldList '}'
                    {
                        ...
                        /*$$.cdef = new Tree.ClassDef(true, $2.ident, $3.ident, $5.flist, $1.loc);*/
                    }
                ;
...
ForeachStmt     :   FOREACH '(' ForeachType IDENTIFIER IN Expr WhileBoolExpr ')' Stmt
                    {
                        $$.stmt = new Tree.ForeachStmt($3.type, $4.ident, $6.expr, $7.expr, $9.stmt, $1.loc);
                    }
                ;
...
GuardStmt       :   '{' IfSubStmtList '}'
                    {
                        $$.stmt = new Tree.Guard($2.iflist, $1.loc);
                    }
                ;

IfSubStmtList   :   IfSubStmt IfSubListQ
                    {
...
IfSubListQ      :   IFOR IfSubStmt IfSubListQ
                    {
                        $$.iflist = new ArrayList<Tree.IfSub>();
...
SimpleStmt      :   Expr Assignment
                ...
                |   VAR IDENTIFIER '=' Expr
                    {
                        $$.stmt = new Tree.VarStmt($2.ident, $4.expr, $1.loc);
                    }
                |   /* empty */
                ;
                                ...
                                if (v.expr != null) {
                                    if (v.expr1 != null){
                                        if (v.counter == Tree.ARRAYSUBARRAY)
                                            $$.expr = new Tree.ArraySubArray($$.expr, v.expr, v.expr1, $1.loc);
                                        else if (v.counter == Tree.ARRAYDEFAULT)
                                            $$.expr = new Tree.ArrayDefault($$.expr, v.expr, v.expr1, $1.loc);
                                    }
                                    else
...
ExprT8          :   '[' Expr SubDefaultArray ExprT8
                    {
...
SubDefaultArray :   ':' Expr ']'
                    {
                        $$.expr = $2.expr;
                        $$.counter = Tree.ARRAYSUBARRAY;
                    }
                |   ']' DefaultExpr
                    {
                        $$ = $2;
...
Expr9           :   Constant
                ...
                |   ARRAYCOMBEGIN Expr FOR IDENTIFIER IN Expr IfBoolExpr ARRAYCOMEND
                    {
...
ArrayConstantList : /* empty */
                    {
                        $$.elist = new ArrayList<Tree.Expr>();
                    }
                |   Constant ArrayConstantLQ
                    {
                        $$.elist = new ArrayList<Tree.Expr>();
                        $$.elist.add($1.expr);
...
ArrayConstantLQ  :   ',' Constant ArrayConstantLQ
                    {
                        $$.elist = new ArrayList<Tree.Expr>();
